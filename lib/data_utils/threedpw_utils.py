...
if __name__ == '__main__':
    ...
    joblib.dump(dataset, osp.join(GLoT_DB_DIR, '3dpw_val_db.pt'))

    dataset = read_data(args.dir, 'test', debug=debug)
    joblib.dump(dataset, osp.join(GLoT_DB_DIR, '3dpw_test_db.pt'))

    dataset = read_data(args.dir, 'train', debug=debug)
    joblib.dump(dataset, osp.join(GLoT_DB_DIR, '3dpw_train_db.pt'))
