    ...
    for subject in subjects:
        ...
        for seq in tqdm(seq_list):
            ...
            for img_i in tqdm(range(num_frames)):
                ...
                J_regressor = torch.from_numpy(np.load(osp.join(GLoT_DATA_DIR, 'J_regressor_h36m.npy'))).float()
...
if __name__ == '__main__':
    ...
    joblib.dump(dataset, osp.join(GLoT_DB_DIR, f'h36m_{args.set}_25fps_tight_db.pt'))  # h36m_train_25fps_occ_db.pt
